...
if __name__ == '__main__':
    ...
    super_market.pick_products()
    super_market.calculate_sales()
    logging.info(f"{[cust.transition for cust in super_market.customers_inactive[:4]]}")
    ...
    print(day_df[day_df['customer_no'].isin(range(10))].sort_values(by='timestamp'))
